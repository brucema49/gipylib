...
- [ ] **Step 1: Add a writer capture and failing LC assertion**
...
- [ ] **Step 2: Run the focused LC test and verify the expected failure**
...
- [ ] **Step 3: Add the analogous failing TC assertion**
...
- [ ] **Step 4: Run the focused TC test and verify the expected failure**
...
- [ ] **Step 1: Change the interpolation branch to write only pre-update state if required by existing output semantics**
...
- [ ] **Step 2: Write the fused state immediately after `_apply_gnss_update(gnss)`**
...
- [ ] **Step 1: Remove the pre-measurement Qins=3 leakage**
...
- [ ] **Step 2: Write the fused state immediately after `_trigger_meas(...)`**
...
- [ ] **Step 1: Record baseline metrics from the current configured result**
...
- [ ] **Step 4: Run the evaluator and compare metrics**
...
- [ ] **Step 5: Run syntax and focused/full regression checks**
